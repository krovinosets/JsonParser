...
public:
    Json_errors(const std::string& info, const std::string& expected_str, const int pos_in_file, const int pos_in_line) : info{info}, expected_str{expected_str}, pos_in_file{pos_in_file}, pos_in_line{pos_in_line}{}
